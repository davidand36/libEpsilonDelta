/*
  ...
  PersianArithmeticDate class, representing a date in the Persian calendar.
*/
...
bool
TestPersianArithmeticDate( )
{
    bool ok = true;
    cout << "Testing PersianArithmeticDate" << endl;

    cout << "PersianArithmeticDate() [default constructor]" << endl;
    PersianArithmeticDate persDate;
    ...
    cout << "PersianArithmeticDate( true ) [today constructor]" << endl;
    PersianArithmeticDate persToday( true );
    ...
    int jd = 2431772;
    cout << "PersianArithmeticDate( " << jd << " ) [Julian Day constructor]" << endl;
    PersianArithmeticDate persJD( jd );
    ...
    m = 8;
    y = 1324;
    cout << "PersianArithmeticDate( " << d << ", " << m << ", " << y
         << " ) [D,M,Y constructor]" << endl;
    PersianArithmeticDate persDMY( d, m, y );
    ...
    jd = 1948320;
    cout << "PersianArithmeticDate( " << jd << " ) [Julian Day constructor]" << endl;
    PersianArithmeticDate pers0( jd );
    ...
    cout << "PersianArithmeticDate( " << d << ", " << m << ", " << y
         << " ) [D,M,Y constructor]" << endl;
    PersianArithmeticDate pers110( d, m, y );
    ...
    cout << "PersianArithmeticDate( pers0 ) [copy constructor]" << endl;
    PersianArithmeticDate persEq = pers0;
    ...
    cout << "PersianArithmeticDate( GregorianDate( 22, 3, 622 ) ) [DateDMY constructor]" << endl;
    PersianArithmeticDate persGreg( GregorianDate( 22, 3, 622 ) );
    ...
    cout << "GregorianDate( PersianArithmeticDate( 1, 7, 1340 ) ) [conversion]" << endl;
    GregorianDate gregPers( PersianArithmeticDate( 1, 7, 1340 ) );
    TESTCHECK( gregPers.Valid( ), true, &ok );
    TESTCHECK( gregPers.ToString( ), string( "Saturday, 23 September 1961" ), &ok );
    cout << "= PersianArithmeticDate( 13, 1, 1381 )" << endl;
    gregPers = PersianArithmeticDate( 13, 1, 1381 );
    TESTCHECK( gregPers.Valid( ), true, &ok );
    TESTCHECK( gregPers.ToString( ), string( "Tuesday, 2 April 2002" ), &ok );

    cout << "= PersianArithmeticDate( 21, 8, 1324 )" << endl;
    gregPers = PersianArithmeticDate( 21, 8, 1324 );
    TESTCHECK( gregPers.Valid( ), true, &ok );
    ...
    if ( ok )
        cout << "PersianArithmeticDate PASSED." << endl << endl;
    else
        cout << "PersianArithmeticDate FAILED." << endl << endl;
    return ok;
}
